...
public:
    ...
    int WeightIs(VertexType, VertexType) const;//weight of edge from first vertex to second
    void GetToVertices(VertexType, Queue<VertexType>&) const;//fills passed queue with all vertexes that the passed vertex has an edge to
    void ClearMarks();
