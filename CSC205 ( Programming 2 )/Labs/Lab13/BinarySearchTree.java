...
// the use of the constructors from BinaryTreeBasis
  ...
  public boolean duplicateCheck( BinarySearchTree otherTree ){
    return duplicateCheck( this.root, otherTree.root );
  }
  ...
  private boolean duplicateCheck( TreeNode t1, TreeNode t2 ){
    if( t1 == null && t2 == null )
      ...
      return false;
    Comparable n1 = ((KeyedItem) t1.getItem()).getKey();
    Comparable n2 = ((KeyedItem) t2.getItem()).getKey();
    if( n1.compareTo( n2 ) != 0 )
      return false;
    boolean checkLeft = duplicateCheck( t1.getLeft(), t2.getLeft() );
    boolean checkRight = duplicateCheck( t1.getRight(), t2.getRight() );
